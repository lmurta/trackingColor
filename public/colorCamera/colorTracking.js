    ...
    $( document ).ready(function() {
		...
		var ax=110; ay=110; aw=30;ah=30;dx=135;dy=0;
		...
		//fx = new CanvasEffects(trkcanvas,{
		//	workerPath:'/bower_components/CanvasEffects/CanvasEffects.worker.min.js'
		//});
