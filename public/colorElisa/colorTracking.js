$(document).ready(function() {
    ...
    divImage.onload = function() {
        ...
        for (var i = 0; i < numAreas; i++) {
            ...
            if (length <= 0) {
                ...
                if (angulo < 10) {
                    ...
                    faixaCor++;
                    if (angulo < 20) {
                        angulo_cor = "Red-Orange";
                    } else {
                        faixaCor++;
                        if (angulo < 40) {
                            angulo_cor = "Orange-Brown";
                        } else {
                            faixaCor++;
                            if (angulo < 50) {
                                angulo_cor = "Orange-Yellow";
                            } else {
                                faixaCor++;
                                if (angulo < 60) {
                                    angulo_cor = "Yellow";
        ...
        plot = $.plot("#flot1", incomingData, {
            ...
            grid: {
                hoverable: true,
                markings: [{
                        color: one.color('hsl(' + faixaNames[gradiente][1] + ',' + gSat + ',' + gLigth + ')').css(),
                        lineWidth: 1,
                        yaxis: {
                            from: faixaNames[gradiente][0] / 360,
                            to: faixaNames[gradiente++][1] / 360
                        }
                    }, {
                        color: one.color('hsl(' + faixaNames[gradiente][1] + ',' + gSat + ',' + gLigth + ')').css(),
                        lineWidth: 1,
    ...
    tracking.ColorTracker.registerColor('223329', function(r, g, b) {
        ...
        if ((r < (34 + delta)) && (r > (34 - delta)) &&
            ...
            (b < (41 + delta)) && (b > (41 - delta))) { //34,51,41
            return true;
        }
        return false;
    });
